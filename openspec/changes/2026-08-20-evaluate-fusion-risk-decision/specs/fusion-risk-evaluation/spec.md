...
PASS/RECHECK 必须为 LOW/ALLOW；无冲突的 REJECT_ITEM/HOLD_BATCH 必须为 MEDIUM/ALLOW，有冲突时必须 REQUIRE_APPROVAL；STOP_LINE/ESCALATE 必须为 HIGH/REQUIRE_APPROVAL。REQUIRE_APPROVAL 不得表述为已授权或已执行。
