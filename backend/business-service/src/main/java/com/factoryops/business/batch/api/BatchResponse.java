...
public record BatchResponse(
    ...
    @JsonProperty("held_at") Instant heldAt,
    @JsonProperty("hold_reason_code") String holdReasonCode,
    @JsonProperty("hold_reason_detail") String holdReasonDetail,
    @JsonProperty("hold_inspection_id") String holdInspectionId,
    @JsonProperty("hold_result_id") String holdResultId,
